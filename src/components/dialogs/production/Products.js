                            ...
                            {products.map(product =>
                                <li key={product.uuid}>
                                    <div className="flexbox">
                                        <span className="cell-title content-size"><img src={require("../../../static/icons/" + product.productCategoryIconPath)} className="icon" alt="" /><b>{product.name}</b> ({product.unitsSold} sold)</span>
